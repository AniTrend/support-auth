...
import co.anitrend.support.auth.core.utils.PreferenceUtils
...
class GoogleAuthActivity : CoreAuthActivity(), GoogleApiClient.OnConnectionFailedListener, GoogleApiClient.ConnectionCallbacks {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val clientId = getMetaValue(R.string.co_anitrend_support_auth_googleWebClientId)
        ...
        try {
            ...
            when (googleSignInAccount != null) {
                true -> onSocialSuccess(SocialUser().apply {
                    ...
                    Timber.e("googleSignInAccountTask returned null")
                    onCancellation()
                }
            }
    ...
    companion object {
        ...
        private val KEY_IS_GOOGLE_DISCONNECT_REQUESTED =
            GoogleAuth::class.java.name + "KEY_IS_GOOGLE_DISCONNECT_REQUESTED"
        private val KEY_IS_GOOGLE_REVOKE_REQUESTED =
            GoogleAuth::class.java.name + "KEY_IS_GOOGLE_REVOKE_REQUESTED"
