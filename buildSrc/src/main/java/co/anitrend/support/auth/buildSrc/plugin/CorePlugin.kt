package co.anitrend.support.auth.buildSrc.plugin

import co.anitrend.support.auth.buildSrc.plugin.components.*
import co.anitrend.support.auth.buildSrc.plugin.components.configureAndroid
import co.anitrend.support.auth.buildSrc.plugin.components.configureDependencies
import co.anitrend.support.auth.buildSrc.plugin.components.configureOptions
import co.anitrend.support.auth.buildSrc.plugin.components.configurePlugins
