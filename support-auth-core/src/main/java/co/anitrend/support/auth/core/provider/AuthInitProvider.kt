package co.anitrend.support.auth.core.provider
...
open class AuthInitProvider : ContentProvider() {
     ...
     * As a courtesy, call [notifyChange()](android.content.ContentResolver.notifyChange)
     * after inserting.
     * This method can be called from multiple threads, as described in
     * [Processes and Threads]({@docRoot}guide/topics/fundamentals/processes-and-threads.html#Threads).
